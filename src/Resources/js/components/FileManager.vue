            ...
            <div class="navbar box-shadow">
                <div class="breadcrumb">
                    <el-breadcrumb separator-class="el-icon-arrow-right">
                        ...
                        >
                            <a href="#" @click="handleDiscover(item.path)">{{ item.name }}</a>
                        </el-breadcrumb-item>
                    </el-breadcrumb>
                </div>
                <div class="wrapper">
                    <div class="common-button">
                        ...
                        <el-upload
                            ...
                            :action="this.domain + '/file-manager/single-upload'"
                        >
                            <el-button
            ...
            <div class="main-wrapper">
                <div class="content">
                    <div class="folder-list">
                        ...
                        >
                            <img src="/vendor/file-manager/img/folder.jpg"
                                 alt=""
    ...
    methods: {
        ...
        getFileThumbnail(file) {
            ...
            if(this.isVideo(file.mime)) {
                return '/vendor/file-manager/img/video.png';
            }

            return '/vendor/file-manager/img/file.png';
        ...
        handleChooseImage(payload) {
            if(this.hasEditor) {
                ...
                window.open(this.domain + payload.url);
            }
        },
        buildBreadCrumb() {
            this.breadCrumb = [
        ...
        async handleUpload(data) {
            ...
            try {
                ...
                const uri = this.domain + '/file-manager/single-upload';
        ...
        async handleDiscover(path) {
            ...
            try {
                ...
                const uri = this.domain + '/file-manager/discover?dir=' + directory;
        ...
        async handleDelete() {
            ...
            try {
                ...
                for(let i = 0; i < this.directories.length; i++) {
                    if(this.directories[i].is_selected) {
                        directories.push(this.directories[i].path);
                    }
                }

                const uri = this.domain + '/file-manager/delete';
        ...
        async handleMakeDirectory() {
            ...
            try {
                ...
                const uri = this.domain + '/file-manager/mkdir';
